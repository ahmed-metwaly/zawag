...
<div class="portlet-body form">
    ...
    <div class="form-body">
        ...
        <div class="form-group">
            <label class="control-label col-md-3">  اسم الموقع عريى
                <span class="required">
                    *
                </span>
            </label>
        ...
        <div class="form-group">
            <label class="control-label col-md-3">  اسم الموقع انجليزى
                <span class="required">
                    *
                </span>
            </label>
            <div class="col-md-4">
                <input name="site_name_en" value="<?php echo $sittingsData->si_site_name_en; ?>" required data-required="1" placeholder="زواج" class="form-control" type="text">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="control-label col-md-3"> رسالة الترحيب عربى
                <span class="required">
                    *
                </span>
            </label>
        ...
        <div class="form-group">
            <label class="control-label col-md-3"> رسالة الترحيب انجليزى
                <span class="required">
                    *
                </span>
            </label>
            <div class="col-md-7">
                ...
                <textarea name="welcome_messag_en" class="form-control" required rows="8"><?php echo $sittingsData->si_welcome_messag_en; ?></textarea>
        ...
        <div class="form-group">
            <label class="control-label col-md-3"> نبذة عن الموقع عربى
                <span class="required">
                    *
                </span>
            </label>
        ...
        <div class="form-group">
            <label class="control-label col-md-3"> نبذة عن الموقع انجليزى
                <span class="required">
                    *
                </span>
            </label>
            <div class="col-md-7">
                ...
                <textarea name="about_the_site_en" class="form-control" required rows="8"><?php echo $sittingsData->si_about_the_site_en; ?></textarea>
        ...
        <div class="form-group last">
            <label class="control-label col-md-3">	شروط الاستخدام									  عريى<span class="required">
                    *
                </span>
            </label>
            <div class="col-md-7">
        ...
        <div class="form-group last">
            <label class="control-label col-md-3">	 شروط الاستخدام									 انجليزى<span class="required">
                    *
                </span>
            </label>
            <div class="col-md-7">
                <textarea class="ckeditor form-control" name="terms_service_en" rows="6" data-error-container="#editor2_error"><?php echo $sittingsData->si_terms_service_en; ?></textarea>
                <div id="editor2_error">
                </div>
            </div>
        </div>
        ...
        <div class="form-group last">
            <label class="control-label col-md-3">نصائح واقتراحات 									 عربى<span class="required">
                    *
                </span>
            </label>
            <div class="col-md-7">
        ...
        <div class="form-group last">
            <label class="control-label col-md-3">نصائح واقتراحات 									 انجليزى<span class="required">
                    *
                </span>
            </label>
            <div class="col-md-7">
                <textarea class="ckeditor form-control" name="tips_and_suggestions_en" rows="6" data-error-container="#editor2_error"><?php echo $sittingsData->si_tips_and_suggestions_en; ?></textarea>
                <div id="editor2_error">
                </div>
            </div>
        </div>
        ...
        <div class="form-group last">
            <label class="control-label col-md-3"> سياسة الخصوصية 									 عربى<span class="required">
                    *
                </span>
            </label>
            <div class="col-md-7">
        ...
        <div class="form-group last">
            <label class="control-label col-md-3"> سياسة الخصوصية 									 انجليزى<span class="required">
                    *
                </span>
            </label>
            <div class="col-md-7">
                <textarea class="ckeditor form-control" name="privacy_policy_en" rows="6" data-error-container="#editor2_error"><?php echo $sittingsData->si_privacy_policy_en; ?></textarea>
                <div id="editor2_error">
                </div>
            </div>
        </div>
