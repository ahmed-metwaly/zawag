...
<div class="portlet-body form">
    ...
    <div class="form-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <input name="p_name_en" value="<?php echo $pageData['p_name_en']; ?>" required data-required="1" placeholder="" class="form-control" type="text">
            </div>
        </div>
        
        <div class="form-group">
            <label class="control-label col-md-2"> عنوان الصفحة عربى
                <span class="required">
                    *
                </span>
            </label>
        ...
        <div class="form-group">
            <label class="control-label col-md-2"> عنوان الصفحة انجليزى
                <span class="required">
                    *
                </span>
            </label>
            <div class="col-md-8">
                <input name="p_title_en" value="<?php echo $pageData['p_title_en']; ?>"  class="form-control" placeholder="" type="text">
            </div>
        </div>
        ...
        <div class="form-group last">
            ...
            <div class="col-md-8">
                <textarea style="direction: rtl !important; text-align: right !important;" class="ckeditor description ckeditor desc" name="p_content_en"  data-error-container="#editor2_error"><?php echo $pageData['p_content_en']; ?></textarea>
                <div id="editor2_error">
                </div>
            </div>
        </div>
