...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
    <?php // print_r($test); ?>
    <?php echo form_open(HOST_NAME . 'admin/adminLogin/', array('class' => 'login-form')) ?>
		<h3 class="form-title">تسجيل دخول لوحة التحكم</h3>
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="البريد الالكترونى" name="username"/>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-actions">
			...
			<button type="submit" name="loginAdmin" class="btn blue pull-right">
