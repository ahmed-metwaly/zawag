...
<div class="portlet-body form">
    ...
    <div class="form-body">
        ...
        <div class="form-group">
            <label class="control-label col-md-2"> العنوان عريى
                <span class="required">
                    *
                </span>
            </label>
        ...
        <div class="form-group">
            <label class="control-label col-md-2"> العنوان انجلبزى
                <span class="required">
                    *
                </span>
            </label>
            <div class="col-md-8">
                <input name="sf_title_en" required data-required="1" placeholder="" class="form-control" type="text">
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="control-label col-md-2"> نص الخدمة عريى
                <span class="required">
                    *
                </span>
            </label>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <textarea name="sf_text_en" class="form-control" style="height: 200px;"></textarea>
            </div>
        </div>
