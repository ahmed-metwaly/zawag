...
<div class="portlet-body form">
    ...
    <div class="form-body">
        ...
        <div class="form-group">
            <label class="control-label col-md-2"> اسم الخطة عربى
                <span class="required">
                    *
                </span>
            </label>
        ...
        <div class="form-group">
            <label class="control-label col-md-2"> اسم الخطة  انجليزى
                <span class="required">
                    *
                </span>
            </label>
            <div class="col-md-8">
                <input name="pp_name_en" required data-required="1" placeholder="" value="<?php echo $planData->pp_name_en; ?>" class="form-control" type="text">
            </div>
        </div>
