...
<div class="portlet-body form">
    ...
    <div class="form-body">
        ...
        <div class="form-group">
            <label class="control-label col-md-2">   السؤال عربى
                <span class="required">
                    *
                </span>
            </label>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <input name="f_question_en" value="<?php echo $faqsData['f_question_en']; ?>" required data-required="1" placeholder="" class="form-control" type="text">
            </div>
        </div>
        
        <div class="form-group">
            <label class="control-label col-md-2"> الاجابة عربى
                <span class="required">
                    *
                </span>
            </label>
        ...
        <div class="form-group">
            <label class="control-label col-md-2"> الاجابة انجليزى
                <span class="required">
                    *
                </span>
            </label>
            <div class="col-md-8">
                <textarea class="ckeditor form-control" name="f_answer_en" rows="6" data-error-container="#editor2_error"><?php echo $faqsData['f_answer_en']; ?></textarea>
            </div>
        </div>
