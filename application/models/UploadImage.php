...
##### Saves image resource to file #####
    ...
    public function upload($thumb_square_size = 200, $max_image_size = 500, $thumb_prefix = 'thumb_', $destination_folder = '', $jpeg_quality = 90) {

############ Configuration ##############
        $thumb_square_size 		= $thumb_square_size; //Thumbnails will be cropped to 200x200 pixels
        $max_image_size 		= $max_image_size; //Maximum image size (height and width)
        $thumb_prefix			= $thumb_prefix; //Normal thumb Prefix
        $destination_folder		= isset($destination_folder) && $destination_folder != '' ? $destination_folder :  UPLOAD_FILE; //upload directory ends with / (slash)
